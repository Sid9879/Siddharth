...
const contactInfo = [
  {
    icon: <Mail size={20} />,
    label: "Email",
    value: "singhsiddharth1438@gmail.com",
  ...
  },
  {
    ...
    label: "Phone",
    value: "+91 7394090894",
    href: "tel:+917394090894",
  },
  {
    icon: <MapPin size={20} />,
    label: "Location",
    value: "Moti Nagar, Delhi, India",
    href: null,
  },
  {
    icon: <LinkedinIcon size={20} />,
    label: "LinkedIn",
    value: "siddharth-singh-0b363b256",
    href: "https://www.linkedin.com/in/siddharth-singh-0b363b256/",
  },
  {
    icon: <GithubIcon size={20} />,
    label: "GitHub",
    value: "github.com/Sid9879",
    href: "https://github.com/Sid9879",
  },
];

const FORM_ENDPOINT = "https://formspree.io/f/maqggbjy";
          ...
          >
            <div className="contact__info-header glass-card">
              ...
              <p className="contact__info-text">
                I'm actively seeking backend development opportunities. Whether
